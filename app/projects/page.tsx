  ...
  return (
    <div className="min-h-screen text-black relative">
      ...
      <main className="flex flex-col items-end justify-start min-h-screen max-w-7xl ml-auto px-6 sm:px-12 sm:pr-24 pt-16">
        ...
        {/* Projects Grid */}
        <div className="w-full grid grid-cols-1 gap-12 mb-24">
            ...
            <div key={index} className="group w-full max-w-[672px] mx-auto">
              ...
              <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 group-hover:border-gray-300">
                ...
                <div className="p-8">
                  ...
                  {/* Project Description */}
                  <p className="text-[16px] leading-[1.6] mb-6 opacity-90">
                    {project.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.technologies.map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className="px-3 py-1 bg-gray-100 text-[13px] rounded-full font-medium text-gray-700">
                        {tech}
                      </span>
                    ))}
                  </div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-[16px] font-medium hover:opacity-70 transition-opacity duration-200">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 24 24"
