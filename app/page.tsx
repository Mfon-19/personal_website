...
export default function Home() {
  return (
    <div className="min-h-screen text-black relative">
      ...
      <main className="main-content flex flex-col items-center md:items-end justify-center min-h-screen max-w-7xl mx-auto md:ml-auto px-4 sm:px-6 md:px-12 lg:pr-24">
        <h1 className="text-[48px] sm:text-[68px] md:text-[88px] lg:text-[110px] font-semibold text-center md:text-right mb-8 md:mb-12 leading-tight">
          mfon udoh
        </h1>
